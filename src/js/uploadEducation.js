				...
				if(malaysiaStage2ApplyWayId.indexOf(data.student_misc_data.admission_placement_apply_way) !== -1){
					...
					<p>
						...
						<ul>
							...
							<li><b>步驟③ 紙本繳件</b>：至2月28日（星期日）止，請於填報系統『下載報名表件』頁面列印系統產生的報名表件，並附上簡章規定文件，於期限內送交<a href="https://www.ocac.gov.tw/OCAC/Pages/VDetail.aspx?nodeid=1873&pid=23725386" target="_blank>保薦單位</a>（例：留台同學會、獨中）。</li>
						</ul>
						<br />
					</p>
					<hr>
					...
					<p>
						...
						<ul>
							...
							<li><b>步驟③ 紙本繳件</b>：至3月31日（星期三）止，請於填報系統『下載報名表件』頁面列印系統產生的報名表件，並附上簡章規定文件，於期限內送交<a href="https://www.ocac.gov.tw/OCAC/Pages/VDetail.aspx?nodeid=1873&pid=23725386" target="_blank">保薦單位</a>（例：留台同學會、獨中）。</li>
						</ul>
						<br />
					</p>
					<hr>
