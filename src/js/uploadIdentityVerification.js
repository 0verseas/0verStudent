	...
	*/
	...
	let item_block = [
		{},
		{
			...
			'<ol><li>請上傳學士或碩士畢業證書或修業證明書（應屆畢業生，請上傳本學期在學證明書或學生證）。</li><li>所持身分及學歷證件正本須至台北經濟文化辦事處 (澳門辦事處)辦理核驗，始完成報名程序，未完備前開程序者，一律不予分發。</li></ol><small>註：<ol><li>持澳門學歷者請逕攜帶學歷證件正本至台北經濟文化辦事處 (澳門辦事處)辦理核驗。</li><li>核驗前，如申請人係持香港、澳門以外之外國學歷證件須先經由學歷完成地之我政府駐外機構驗證；大陸地區之學歷證件（畢業證書、學位證書、歷年成績單），應先經大陸地區指定之機構或委託民間團體辦理認證 (學歷採認流程詳見附檔)。</li></small>']
		},{
			...
			'<ol><li>持澳門學歷者請逕攜帶學歷證件正本至台北經濟文化辦事處 (澳門辦事處)辦理核驗。</li><li>2.	核驗前，如申請人係持香港、澳門以外之外國學歷證件須先經由學歷完成地之我政府駐外機構驗證；大陸地區之學歷證件（畢業證書、學位證書、歷年成績單），應先經大陸地區指定之機構或委託民間團體辦理認證 (學歷採認流程詳見附檔)。</li></ol>']
		},{
